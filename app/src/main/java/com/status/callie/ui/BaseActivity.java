...
import com.status.callie.utils.LPreviewUtilsBase;
...
import com.status.callie.Utils;
...
public class BaseActivity extends AppCompatActivity {
    ...
    protected void onActionBarAutoShowOrHide(boolean shown) {
        ...
        for (Vieprivate static final String TAG = makeLogTag(BaseActivity.class);
